...
public class GetTotal extends Configuration implements Tool{
	...
	public static void main(String[] args) throws Exception{
		int res=ToolRunner.run(new Configuration(), new GetTotal(),args);
		System.exit(res);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(GetTotal.class);
